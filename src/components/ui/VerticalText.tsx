...
export const VerticalText: FC = () => {
  return (
    <div
      className={`${caveaet.className} absolute top-1 right-[137px] pointer-events-none block rotate-[5deg] font-medium tracking-wide text-3xl z-10 text-right text-milk text-container`}
    >
